...
:
	...
	// Porting the previous line to OpenFOAM-dev
	etaStab_(dimensioned<scalar>::lookupOrDefault("etaStab", dict, dimMass/(dimLength*dimTime), 0.0))
	// or use one of the other constructors (but then without a default value):
	//etaStab_(dimensionedScalar("etaStab", dimMass/(dimLength*dimTime), dict))
{}
